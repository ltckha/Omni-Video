# Rule: Thảo Luận & Hỏi Ý Kiến Trước Khi Thực Hiện (Always Discuss & Confirm Before Execution)

- **NGUYÊN TẮC THẢO LUẬN BẮT BUỘC**: Trước khi thực hiện bất kỳ thay đổi nào về mã nguồn, cấu trúc kịch bản prompt, quy trình tự động hóa hay chỉnh sửa file trong dự án, AI BẮT BUỘC phải:
